...
A function can be declared to receive any number of arguments. Arguments  
 ...
 ## The challenge:  
  ...
  Name each argument (inputs that are created in fxn) as you like.  
   ...
   */
     ...
     function math (firstAlgebra, secondMultiply, thirdDivide) {
      return (firstAlgebra + (secondMultiply * thirdDivide));
